...
# main config
PLUGINSLUG="restrict-content-pro-download-monitor" # returns basename of current directory
CURRENTDIR=`pwd`
MAINFILE="rcp-download-monitor.php" # this should be the name of your main php file in the wordpress plugin
